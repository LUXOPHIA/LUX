...
function RLogGamma( const X_:TdSingle ) :TdSingle; overload;
function RLogGamma( const X_:TdDouble ) :TdDouble; overload;
...
function RLogGamma( const X_:TdSingle ) :TdSingle;
const
...
function RLogGamma( const X_:TdDouble ) :TdDouble;
const
